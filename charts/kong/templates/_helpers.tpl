...
{{- if and .Values.proxy.http.enabled .Values.proxy.tls.enabled -}}
   0.0.0.0:{{ .Values.proxy.http.containerPort }},0.0.0.0:{{ .Values.proxy.tls.containerPort }} ssl{{- range .Values.proxy.additionalPorts }},0.0.0.0:{{ .containerPort }}{{- range .parameters }} {{ . }}{{- end }}{{- end }}
{{- else -}}
{{- if .Values.proxy.http.enabled -}}
   0.0.0.0:{{ .Values.proxy.http.containerPort }}{{- range .Values.proxy.additionalPorts }},0.0.0.0:{{ .containerPort }}{{- range .parameters }} {{ . }}{{- end }}{{- end }}
{{- end -}}
{{- if .Values.proxy.tls.enabled -}}
   0.0.0.0:{{ .Values.proxy.tls.containerPort }} ssl{{- range .Values.proxy.additionalPorts }},0.0.0.0:{{ .containerPort }}{{- range .parameters }} {{ . }}{{- end }}{{- end }}
{{- end -}}
{{- end -}}
